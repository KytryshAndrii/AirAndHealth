...
export const CitySelectBlock = ({getCountryParams, getCityParams}) => {
    ...
    return(
        <div className="absolute  top-[7%] left-[50%] translate-x-[-50%] translate-y-[-7%] z-10000 w-[60%] h-12 bg-zinc-100 shadow-gray-800 rounded-lg caret-transparent cursor-pointer">
