...
export const CitySelectBlock = ({getCountryParams, getCityParams}) => {
    ...
    return(
        <div className="absolute p-1  top-[4%] left-[50%] translate-x-[-50%] translate-y-[-7%] z-10000 w-[60%] h-14 bg-slate-950 shadow-gray-800 rounded-lg caret-transparent cursor-pointer">
